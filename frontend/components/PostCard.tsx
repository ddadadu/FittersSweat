...
export default function PostCard({ post }: PostCardProps) {
  ...
  return (
    <article
      ...
      className="group bg-[#141414] border border-[#262626] rounded-xl p-5 hover:border-white/30 transition-all cursor-pointer flex flex-col justify-between gap-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FFD700]"
    >
      ...
      <div className="flex items-center justify-between pt-3 border-t border-[#262626] text-xs text-[#737373]">
